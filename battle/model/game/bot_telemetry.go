...
func (gs *GameState) flushBotAIMetrics() {
	...
	observability.RecordBotAIMetrics(observability.Default, observability.BotAIMetricSample{
		...
		MLTacticalTeamVictory:     metrics.MLTacticalTeamVictory,
		MLTacticalFocusFire:       metrics.MLTacticalFocusFire,
		MLTacticalAllyHelp:        metrics.MLTacticalAllyHelp,
		MLTacticalCover:           metrics.MLTacticalCover,
		MLTacticalSmartRetreat:    metrics.MLTacticalSmartRetreat,
		MLTacticalSafetyFallbacks: metrics.MLTacticalSafetyFallbacks,
