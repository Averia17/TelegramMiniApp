...
func (runner *CombatScenarioRunner) RecordBotAIMetrics(prefix string) error {
	...
	values := map[string]float64{
		...
		"mlTacticalTeamVictory":     float64(metrics.MLTacticalTeamVictory),
		"mlTacticalFocusFire":       float64(metrics.MLTacticalFocusFire),
		"mlTacticalAllyHelp":        float64(metrics.MLTacticalAllyHelp),
		"mlTacticalCover":           float64(metrics.MLTacticalCover),
		"mlTacticalSmartRetreat":    float64(metrics.MLTacticalSmartRetreat),
		"mlTacticalSafetyFallbacks": float64(metrics.MLTacticalSafetyFallbacks),
