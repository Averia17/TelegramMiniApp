...
var Heroes = withHeroKits(withAttackConfigs([]Hero{
	{Name: "Needle", Color: "#75D947", Radius: 14, MaxLives: 620, Speed: 12, AttackDamage: 65, AttackRate: 420, ReloadTime: 1750, MaxAmmo: 3, BulletSpeed: 23, BulletSize: 15, AttackType: "spore", Role: "Controller", RegenRate: .011, Desc: "Spore capsule splits into six seeking thorns and zones enemies"},
