...
from sqlalchemy import BIGINT, ForeignKey, String, UniqueConstraint, ARRAY, Integer
...
class User(Base, TimestampMixin, TableNameMixin):
    ...
    received_invite: Mapped[list["Invite"]] = relationship(back_populates="invitee", foreign_keys="[Invite.invitee_id]")
