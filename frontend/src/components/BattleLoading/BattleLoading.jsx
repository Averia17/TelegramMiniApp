...
export const BattleLoading = ({progress = 28, status = "Подключаемся к арене...", onCancel = null}) => {
  ...
  return (
    <div className="battle-loading-screen" data-testid="battle-loading" role="status" aria-live="polite">
      ...
      <div className="battle-loading__card">
        {onCancel && <button className="battle-loading__close" type="button" onClick={onCancel} aria-label="Отменить поиск соперника" title="Отменить поиск">×</button>}
