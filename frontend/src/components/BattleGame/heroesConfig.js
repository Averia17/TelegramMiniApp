...
export const HEROES_CONFIG = Object.freeze([
  ...
  {name:"Katty",color:"#FF5C9A",maxLives:640,speed:14,attackDamage:42,attackType:"katty_paint_queue",role:"Controller",attack:{archetype:"burst",aimShape:"cone",range:240,projectileCount:3,spreadDegrees:45,halfArcDegrees:22.5,modifier:"katty_paint_layers"}},
])
