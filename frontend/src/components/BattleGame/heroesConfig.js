...
export const HEROES_CONFIG = Object.freeze([
  ...
  {name:"Katty",color:"#FF5C9A",maxLives:640,maxAmmo:3,speed:14,attackDamage:42,attackType:"katty_paint_spray",role:"Controller",attack:{archetype:"projectile",aimShape:"line",range:220,projectileKind:"katty_paint_spray",modifier:"katty_paint_cloud"}},
])
