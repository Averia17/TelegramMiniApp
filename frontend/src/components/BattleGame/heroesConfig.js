...
export const HEROES_CONFIG = Object.freeze([
  ...
  {name:"Katty",color:"#FF5C9A",maxLives:640,maxAmmo:3,speed:14,attackDamage:52,attackType:"katty_paint_spray",role:"Controller",attack:{archetype:"projectile",aimShape:"line",range:220,projectileKind:"katty_paint_spray",splashRadius:58,modifier:"katty_paint_cloud"}},
])
...
export const HERO_KITS = Object.freeze({
  ...
  Katty: {basic:{id:"paint_spray",name:"Краска-пшик",description:"Короткий направленный пшик наносит 52 урона всем целям в радиусе 58 и оставляет облако краски; третье нанесение по цели даёт заметный бонус и оглушение."},super:{id:"paint_grenade",name:"Красящая лужа",description:"Katty создаёт под собой лужу радиусом 220: после активации она наносит 70 урона, наносит третий слой краски и замедляет врагов.",slot:"primary",prediction:"server"},gadget:{id:"paint_flight",name:"Красколёт",description:"На 2,2 секунды ускоряет Кэтти и позволяет перелетать стены, оставляя замедляющий след; по окончании она безопасно приземляется на свободную зону.",slot:"secondary",prediction:"server"}},
})
