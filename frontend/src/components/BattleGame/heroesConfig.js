...
export const HEROES_CONFIG = Object.freeze([
  ...
  {name:"Fairy Mina",color:"#FF8FE8",maxLives:650,maxAmmo:3,speed:14,attackDamage:55,bulletSpeed:30,attackType:"mina_star_fan",role:"Support",attack:{archetype:"shotgun",aimShape:"cone",range:510,projectileCount:3}},
...
export const HERO_KITS = Object.freeze({
  ...
  "Fairy Mina": {basic:{id:"star_fan",name:"Звёздный веер",description:"Звёзды наносят 55 урона и лечат Mina на 5 HP за попадание; третье попадание взрывает метку на 80 урона в радиусе 100."},super:{id:"star_cocoon",name:"Звёздный кокон",description:"Всегда применяется на Mina: щит 500 HP на 4 секунды и аура радиусом 180 лечит её и наносит врагам урон.",slot:"primary",prediction:"server"},gadget:{id:"repelling_wave",name:"Отталкивающая волна",description:"Волна радиусом 150 наносит 30 урона, отбрасывает врагов и очищает отрицательные эффекты Mina.",slot:"secondary",prediction:"server"}},
  ...
  Katty: {basic:{id:"paint_spray",name:"Краска-пшик",description:"Пшик наносит 55 урона в радиусе 65; третий слой даёт +45% урона и оглушение."},super:{id:"paint_grenade",name:"Красящая лужа",description:"Лужа радиусом 220 слегка притягивает врагов, наносит 70 урона, ослепляет и замедляет их.",slot:"primary",prediction:"server"},gadget:{id:"paint_flight",name:"Красколёт",description:"На 2,2 секунды ускоряет Katty и оставляет след; касание следа взрывает его на 40 урона и 2 слоя краски.",slot:"secondary",prediction:"server"}},
})
