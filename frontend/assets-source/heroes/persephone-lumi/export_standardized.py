"""Export Persephone Lumi base rig and grip-centred weapon GLBs."""
...
weapon = bpy.data.objects["HeroAttachment_WeaponHeld"]
...
standalone = bpy.data.objects.new("HeroAttachment_WeaponHeld", mesh)
