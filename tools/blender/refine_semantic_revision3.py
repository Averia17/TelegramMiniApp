...
POSES = {
    ("needle", "gadget"): {
        ...
        "anchors": [
            (0, {}),
            (3, {"Chest": d(10, 0, 0), "LeftArm": d(-18, 0, -16), "RightArm": d(-18, 0, 16), "Flower": d(0, -14, 0)}),
            (6, {"Chest": d(-16, 0, 0), "LeftArm": d(-42, 0, -28), "RightArm": d(-42, 0, 28), "Flower": d(0, 28, 0)}),
            (9, {"Chest": d(-9, 0, 0), "LeftArm": d(-28, 0, -18), "RightArm": d(-28, 0, 18), "Flower": d(0, 16, 0)}),
            (12, {}),
        ],
    },
    ("wukong-mico", "gadget"): {
        ...
        "anchors": [
            (1, {}),
            (10, {"hips_s": d(-14), "chest_s": d(12), "R_shoulder_s": d(-24, 0, -18), "L_shoulder_s": d(-24, 0, 18)}),
            (20, {"hips_s": d(-24), "chest_s": d(18), "R_shoulder_s": d(-38, 0, -28), "L_shoulder_s": d(-38, 0, 28), "MIC_Handel_s": d(0, -28, 0)}),
            (40, {"hips_s": d(-16), "chest_s": d(10), "R_shoulder_s": d(-24, 0, -18), "L_shoulder_s": d(-24, 0, 18)}),
            (68, {}),
        ],
    },
    ("persephone-lumi", "gadget"): {
        ...
        "anchors": [
            (1, {}),
            (6, {"chest_s": d(12), "R_shoulder_s": d(-24, 0, -24), "L_shoulder_s": d(-24, 0, 24), "R_weapon_s": d(0, -18, 0)}),
            (13, {"chest_s": d(-20), "R_shoulder_s": d(46, 0, 38), "L_shoulder_s": d(46, 0, -38), "R_weapon_s": d(0, 38, 0), "R_wrist_s": d(0, 30, 0), "L_wrist_s": d(0, -30, 0)}),
            (21, {"chest_s": d(-8), "R_shoulder_s": d(28, 0, 22), "L_shoulder_s": d(28, 0, -22), "R_weapon_s": d(0, 20, 0)}),
            (30, {}),
        ],
    },
    ("brock-zeus", "gadget"): {
        ...
        "anchors": [
            (0, {}),
            (4, {"Chest": d(8), "R_Shoulder": d(-22, 0, -18), "L_Shoulder": d(-18, 0, 16), "L_Wrist": d(0, 18, 0)}),
            (10, {"Chest": d(-12), "R_Shoulder": d(34, 0, 28), "R_Elbow": d(0, -32, 0), "L_Shoulder": d(-28, 0, -18), "L_Wrist": d(0, 34, 0)}),
            (13, {"Chest": d(-8), "R_Shoulder": d(28, 0, 22), "R_Elbow": d(0, -26, 0), "L_Wrist": d(0, 28, 0)}),
            (16, {}),
        ],
    },
    ("fairy-mina", "super"): {
        ...
        "anchors": [
            (0, {}),
            (12, {"chest_s": d(12), "L_shoulder_s": d(-28, 0, 22), "R_shoulder_s": d(-28, 0, -22), "L_wing_down_s": d(0, 28), "R_wing_down_s": d(0, -28)}),
            (25, {"chest_s": d(-18), "L_shoulder_s": d(38, 0, -28), "R_shoulder_s": d(38, 0, 28), "L_wing_up_s": d(0, -42), "R_wing_up_s": d(0, 42), "head_s": d(-12)}),
            (38, {"chest_s": d(-8), "L_shoulder_s": d(25, 0, -18), "R_shoulder_s": d(25, 0, 18), "L_wing_up_s": d(0, -28), "R_wing_up_s": d(0, 28)}),
            (55, {}),
        ],
    },
}
...
def offsets_at(anchors, frame):
    ...
    zero = (0.0, 0.0, 0.0)
    return {name: mix(left[1].get(name, zero), right[1].get(name, zero), t) for name in set(left[1]) | set(right[1])}
